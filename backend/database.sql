...
INSERT INTO `users` VALUES (1,'fredgreg','fred@greg.com','$argon2id$v=19$m=65536,t=5,p=1$1cy6eNa1lqGuy6TimPNASw$EhUwJpP6dnQn6yKlEkv2hyVNhGq9SsIVZidjri8rnUM','i\'m cool','playerOnly','2023-08-14 09:00:00',NULL,'2022-08-16 10:00:00','Paris','https://static.vecteezy.com/ti/vecteur-libre/p1/5544770-profil-icone-design-vecteur-gratuit-vectoriel.jpg','je suis gm'),(2,'romainniort','romain@niort.com','$argon2id$v=19$m=65536,t=5,p=1$axqiAE6csCCwh7gwPE3v1w$Rxz+OtrGxdLBfRsY+dGNNodOVN4zRv4ZQD589nPXcqo','coucou les gens','both','2023-08-14 09:00:00',NULL,'2022-08-14 09:00:00','Nantes',NULL,'je suis plus gm que l\'autre'),(3,'hugo','hugo@mail.com','$argon2id$v=19$m=65536,t=5,p=1$m3kIrB4pbFqO4hY5Fw2EaA$8v8PcD/6mQf9AUaifb7nqMkyd1PeW5wqOSLQ3Uw9aZY',NULL,'playerOnly',NULL,NULL,'2023-08-29 17:07:29','Tours',NULL,NULL);
...
-- Dump completed on 2023-08-29 19:34:59