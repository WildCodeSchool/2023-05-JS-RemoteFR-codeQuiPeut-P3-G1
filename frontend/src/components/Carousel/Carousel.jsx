...
const Carousel = () => {
  ...
  return (
    <div className="carousel">
      ...
      <h2>
        They <span className="titlecarou">tested</span>, they{" "}
        <span className="titlecarou">find</span> their guild and they{" "}
        <span className="titlecarou">like it</span>
      </h2>
      <Slider {...settings}>
        <div className="box">
          ...
          <div className="contentContainer">
            ...
            <div className="pcarou">
              wesh alors, sors ta beuh ta plaquette gros, je suis dans le game
              en claquette gros
            </div>
          </div>
        </div>
